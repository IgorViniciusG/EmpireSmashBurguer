...
export function BagIcon({ setIsOpen }: BagProps) {
  ...
  return (
    <button
      ...
      className="z-50 cursor-pointer fixed bottom-4 right-4 m-3 p-4 rounded-full bg-amber-400 hover:bg-amber-500 hover:scale-110 hover:shadow-xl transition-all duration-200"
    >
